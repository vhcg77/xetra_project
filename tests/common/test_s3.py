...
class TestS3BucketConnectorMethods(unittest.TestCase):
    """
    Testint the S3BucketConnector classs
    """
    ...
    def setUp(self):
        ...
        self.s3_endpoint_url = "https://s3.eu-west-1.amazonaws.com"
    ...
    def test_list_files_in_prefix_ok(self):
        """
        Testing the list_files_in_prefix method for getting 2 files keys
        ...
        self.s3_bucket.delete_objects(
            Delete={"Objects": [{"Key": key1_exp}, {"Key": key1_exp}]}
        )
        # self.s3_bucket.delete_objects(Delete={"Objects": [{"Key": key2_exp}]})
